...
// Add this import at the top of your app.js file, after other imports
...
mongoose.connect('mongodb://localhost:27017/PrettyLittleThing', {
...
// Removed app.locals.users = []; since we're using MongoDB now
...
// Make user info and cart count available to all views
app.use(async (req, res, next) => {
  // Cart count
  res.locals.cartCount = req.session.cart ? 
    req.session.cart.reduce((total, item) => total + item.quantity, 0) : 0;
  
  // User info - enhanced with more details
