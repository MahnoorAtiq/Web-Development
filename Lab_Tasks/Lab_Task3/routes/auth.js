...
router.get('/register', (req, res) => {
  try {
    ...
    res.render('auth/register', { 
      title: 'Register - PrettyLittleThing', 
      layout: 'layouts/auth', 
      error: req.session.error || null 
    });
...
router.post('/register', async (req, res) => {
  try {
    ...
    req.session.message = `Welcome to PrettyLittleThing, ${savedUser.firstName}! Your account has been created successfully.`;
