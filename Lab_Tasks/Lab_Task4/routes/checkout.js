...
router.get('/', async (req, res) => {
  try {
    ...
    if (req.session.user && !formData.fullName) {
      formData.fullName = req.session.user.fullName;
      formData.email = req.session.user.email;
    }
...
router.get('/:orderId', async (req, res) => {
  try {
    ...
    if (req.session.userId && order.userId && order.userId.toString() !== req.session.userId.toString()) {
